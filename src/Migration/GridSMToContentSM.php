...
class GridSMToContentSM extends AbstractMigration implements MigrationInterface
{
    /**
     * @var Connection
     */
    ...
    public function shouldRun(): bool
    {
        ...
        return 
	        isset($columns['grid_sm']) &&
	        !isset($columns['size_sm']);
    }

    public function run(): MigrationResult
    {
        // Führe hier deine Migrationsschritte durch
        $this->connection->executeUpdate("ALTER TABLE tl_content CHANGE grid_sm size_sm varchar(2)");
        
        // Erstelle das Migrationsergebnis
        $result = $this->createResult(
            true,
            'The Column grid_sm was renamed to size_sm.'
        );
